...
function NavButton(props) {
	...
	return(
		...
		>
			...
			<svg className="navButtonIcon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><title>play</title><path fill="currentColor" d="M6 4l20 12L6 28z"/></svg>
		</button>
	)
}
